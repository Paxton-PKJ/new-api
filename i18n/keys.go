...
const (
	...
	MsgTokenProfilesInvalid            = "token.profiles_invalid"
	MsgTokenProfilesRequireAutoGroup   = "token.profiles_require_auto_group"
	MsgTokenProfileNotFound            = "token.profile_not_found"
	MsgTokenRoutePresetNotFound        = "token.route_preset_not_found"
	MsgTokenRoutePresetDirectDisabled  = "token.route_preset_direct_disabled"
	MsgTokenRoutePresetDirectAdminOnly = "token.route_preset_direct_admin_only"
)
